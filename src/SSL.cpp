...
SSLH::SSLH(int sockfd, unsigned opt /* = 0*/): opt_(opt), ssl_(nullptr), bio_(nullptr), bio2_(nullptr)
{
...
SSLH::SSLH(int pfd[2], unsigned opt /* = 0*/): opt_(opt), ssl_(nullptr), bio_(nullptr), bio2_(nullptr)
{
...
SSL *SSLH::CreateH()
{
  ...
  unsigned long ctxopt = SSL_CTX_get_options(ctx);
